      ...
      >
        ...
        <div class="mt-6">
          ...
          <div class="mt-6 grid grid-cols-2 gap-3">
            <Link :href="route('social.login', 'google')" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">
              <span class="sr-only">Sign in with Google</span>
              <img class="h-5 w-5 mr-2" src="https://www.google.com/favicon.ico" alt="Google">
              Google
            </Link>
            <Link :href="route('social.login', 'github')" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">
