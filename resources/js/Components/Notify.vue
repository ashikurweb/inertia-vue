<template>
  <Teleport to="body">
    <div class="fixed top-6 right-6 z-50 w-full max-w-md pointer-events-auto">
      <Transition
      ...
      >
        <div
          v-if="visible"
          class="relative flex items-center gap-4 p-4 rounded-xl backdrop-blur-md border shadow-2xl mb-3"
          :class="[
            type === 'success' 
